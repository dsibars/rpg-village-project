...
await page.evaluate(() => { if (window.__ENGINE__) window.__ENGINE__.update(); });
...
await page.click('.tab-nav .tab-btn:nth-child(2)');
await page.waitForTimeout(800);

// Expand Equipment category
const equipmentSummary = await page.$('details:nth-child(2) summary');
if (equipmentSummary) await equipmentSummary.click();
await page.waitForTimeout(300);

// Click first equipment item
const firstEq = await page.$('details:nth-child(2) .shop-item-row');
if (firstEq) await firstEq.click();
await page.waitForTimeout(300);
await page.screenshot({ path: '/home/dsibars/development/rpg-village-project/ux/_migration_screenshots/test_shop_equipment.png' });

// Expand Helm category
const helmSummary = await page.$('details:nth-child(3) summary');
if (helmSummary) await helmSummary.click();
await page.waitForTimeout(300);
await page.screenshot({ path: '/home/dsibars/development/rpg-village-project/ux/_migration_screenshots/test_shop_allcats.png' });

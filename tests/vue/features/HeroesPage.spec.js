...
describe('HeroesPage', () => {
  ...
  it('opens skills modal when action bar skills button clicked', async () => {
    ...
    await wrapper.findAll('.hero-list-item')[0].trigger('click')
    await flushPromises()
    await wrapper.findAll('.hero-quick-links .btn-secondary')[5].trigger('click')
    await flushPromises()
  ...
  it('opens consumables modal when action bar consumables button clicked', async () => {
    ...
    await wrapper.findAll('.hero-list-item')[0].trigger('click')
    await flushPromises()
    await wrapper.findAll('.hero-quick-links .btn-secondary')[6].trigger('click')
    await flushPromises()
  ...
  it('opens equipment modal when action bar equipment button clicked', async () => {
    ...
    await wrapper.findAll('.hero-list-item')[0].trigger('click')
    await flushPromises()
    await wrapper.findAll('.hero-quick-links .btn-secondary')[4].trigger('click')
    await flushPromises()
  ...
  it('opens inscription modal when action bar inscription button clicked', async () => {
    ...
    await wrapper.findAll('.hero-list-item')[0].trigger('click')
    await flushPromises()
    await wrapper.findAll('.hero-quick-links .btn-secondary')[2].trigger('click')
    await flushPromises()

...
export class InventoryService {
    ...
    _load() {
        ...
        if (!loaded.materials) loaded.materials = defaultData.materials;
        if (!loaded.food) loaded.food = defaultData.food;
        if (!loaded.consumables) loaded.consumables = defaultData.consumables;
